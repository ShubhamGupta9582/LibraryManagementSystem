...
public class ReturnBook extends javax.swing.JFrame {
    ...
    public void insert(){
        ...
        if(jTextField16.getText().isEmpty() || jTextField16.getText().equals(null) || jTextField16.getText().equals("null")){
        
            JOptionPane.showMessageDialog(null, "Empty Return Date or Invalid Values");
        }
        else{
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Return Panel", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Serif", 0, 24))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String sql = "select * from IssueBook where book_id = ?";
            ps = conn.prepareStatement(sql);
            ps.setString(1, jTextField1.getText());
            rs = ps.executeQuery();
            if(rs.next()){
